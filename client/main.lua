...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	if (ESX.PlayerData.job and ESX.PlayerData.job.name == 'cartel' and ESX.PlayerData.job.name == dispatchNumber) or (ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cartel' and ESX.PlayerData.job2.name == dispatchNumber) then
...
AddEventHandler('esx_carteljob:hasEnteredEntityZone', function(entity)
	...
	if ((ESX.PlayerData.job and ESX.PlayerData.job.name == 'cartel') or (ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cartel')) and IsPedOnFoot(playerPed) then
	...
	while true do
		...
		if (ESX.PlayerData.job and ESX.PlayerData.job.name == 'cartel') or (ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cartel') then
			...
			for k,v in pairs(Config.CartelStations) do
				...
				if Config.EnablePlayerManagement and (ESX.PlayerData.job.grade_name == 'boss' or ESX.PlayerData.job2.grade_name == 'boss') then
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, 38) and ((ESX.PlayerData.job and ESX.PlayerData.job.name == 'cartel') or (ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cartel')) then
		...
		if IsControlJustReleased(0, 166) and not isDead and ((ESX.PlayerData.job and ESX.PlayerData.job.name == 'cartel') or (ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cartel')) and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'cartel_actions') then
			if not Config.EnableESXService then
	...
	if (ESX.PlayerData.job and ESX.PlayerData.job.name == 'cartel') or (ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'cartel') then
		ESX.TriggerServerCallback('esx_society:getOnlinePlayers', function(players)
			for i=1, #players, 1 do
				if players[i].job.name == 'cartel' or players[i].job2.name == 'cartel' then
